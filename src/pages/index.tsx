 ...
 * ============================================================
 *
 * Company branding is now controlled through:
 *
 *   src/config/skillwave.config.ts
 *
 * This allows the same shell to be reused for different
 * companies by changing configuration rather than rewriting
 * the dashboard.
 */
...
const favoriteKindLabel = (
  item: SavedFavoriteTopic
) => {
  switch (item.kind) {
    case "interview":
...
function DashboardSlideCarousel({
  topics = [],
}: {
  topics?: DashboardCardTopic[];
}) {
  ...
  const slideStyle = {
    "--dashboard-slide-text-align":
      textAlign,

    ...(activeSlide.style
      ?.titleSize
      ? {
          "--dashboard-slide-title-size":
            activeSlide.style
              .titleSize,
        }
      : {}),
    ...
    ...(activeSlide.style
      ?.mobileImageSize
      ? {
          "--dashboard-slide-mobile-image-size":
            activeSlide.style
              .mobileImageSize,
        }
      : {}),
  ...
  const contentClassName = [
    ...
    selectedTemplate ===
    "imageText"
      ? `dashboard-swipe-card__content--image-${imagePosition}`
      : "",
  ]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    <section
      className="dashboard-slide-carousel"
      aria-label="Topic slides"
    >
      <article
        ...
        tabIndex={0}
        style={slideStyle}
        aria-label={`${activeTopic.title}, slide ${
          slideIndex + 1
        } of ${
          activeTopic.slides.length
        }`}
      >
        ...
        >
          ...
          {showText && (
            ...
            >
              <div
                className="dashboard-swipe-card__eyebrow"
                style={{
                  color:
                    activeTopic.accent,
                }}
              ...
              <h3 className="dashboard-swipe-card__title">
                {
                  activeSlide.title
                }
              </h3>

              <p className="dashboard-swipe-card__body">
                {
                  activeSlide.body
                }
              </p>
        ...
        <div className="dashboard-swipe-card__footer">
          <div
            className="dashboard-swipe-card__dots"
...
export default function Dashboard() {
   ...
   * IMPORTANT:
   *
   * This content continues to come from the configured
   * content repository.
   *
   * The dashboard shell itself does not contain company
   * specific course/interview content.
   */
   ...
   *
   * Now the shell reads the company configuration.
   */
      ...
      () => [
        {
          ...
          description:
            "Open the interview library and practice concise, high-signal answers.",
          ...
          accent:
            "var(--dashboard-section-interview-accent)",

          surfaceLight:
            "var(--dashboard-section-interview-surface)",
...

        {
          ...
          description:
            "Browse subjects and open topic readers from the configured content catalog.",
          ...
          accent:
            "var(--dashboard-section-courses-accent)",

          surfaceLight:
            "var(--dashboard-section-courses-surface)",
...

        {
          ...
          description:
            "Jump into slideshows, training videos, and audio books in one place.",
          ...
          accent:
            "var(--dashboard-section-cbt-accent)",

          surfaceLight:
            "var(--dashboard-section-cbt-surface)",
    ...
    >(() => {
      ...
      for (
        ...
        addResult({
          ...
          meta: item.questionCount
            ? `${item.category} - ${item.questionCount} ${
                item.questionCount ===
                1
                  ? "question"
                  : "questions"
      ...
      for (
        ...
        addResult({
          ...
          accent:
            "var(--dashboard-library-favorites-color)",
        });
      }
  ...
  const syncStatusText =
    isOffline
      ? lastSyncedAt
        ? `Last GitHub update ${formatDateTime(
            lastSyncedAt
          )}`
      ...
      : syncingContent
        ...
        : lastSyncedAt
          ? `GitHub updated ${formatDateTime(
              lastSyncedAt
            )}`
          : "GitHub update time is unavailable right now.";

  const mobileSyncStatusText =
    isOffline
      ? lastSyncedAt
        ? `GitHub ${formatTime(
            lastSyncedAt
  ...
  const secondaryStatusText =
    ...
    "ready"
      ? isOffline
        ? `Workspace cached ${formatDateTime(
            offlineSyncState.syncedAt
          )}.`
        : `Offline workspace updated ${formatDateTime(
            offlineSyncState.syncedAt
          )}.`
      : offlineSyncState
          ?.status ===
   ...
   *
   * "Search Java, topics, interview questions, videos..."
   *
   * Java is no longer hardcoded.
   */

  const searchPlaceholder =
    `Search ${companyName} content, topics, interview questions, videos...`;
    ...
    <div className="app-shell app-shell--dashboard">
      <main className="page-main">
          ...
          >
            ...
            >
              ...
              <div className="page-hero-copy">
                ...
                >
                  <span className="dashboard-sync-text dashboard-sync-text--desktop">
                    {
                      syncStatusText
                    }
                  </span>

                  <span className="dashboard-sync-text dashboard-sync-text--mobile">
                    {
                  ...
                  <span
                    ...
                    style={{
                      ...
                      border:
                        `1px solid ${connectionTone.border}`,
                    }}
                  >
                    <span
                      style={{
            ...
            <div className="page-hero-actions">
              ...
              {installPrompt &&
                !installInstalled && (
                  <button
                    className="btn btn-outline dashboard-action-install"
                    onClick={
                      handleInstall
                    }
                    type="button"
              ...
              <button
                className="btn btn-outline dashboard-action-theme"
                onClick={
                  toggleTheme
                }
                type="button"
              ...
              >
                ...
                <div className="dashboard-profile-btn__copy">
                  <div className="dashboard-profile-btn__name">
                    {
                      firstName
                    }
                  </div>
              ...
              <button
                className="btn btn-outline dashboard-action-logout"
                onClick={
                  handleLogout
                }
                type="button"
        ...
        {tickerItems.length >
          0 && (
          <section
            className="dashboard-ticker-slot mobile-flat-ticker"
            style={{
              marginBottom: 16,
            }}
          >
                    ...
                    return (
                      ...
                      >
                        <div className="card dashboard-search-result-card">
                          ...
                          >
                            <div className="dashboard-search-result-card__kind">
                              {
                                result.kind
                              }
                            </div>

                            <div className="dashboard-search-result-card__title">
                              {
                                result.title
                              }
                            </div>
                            ...
                            <div className="dashboard-search-result-card__meta">
                              {
                                result.meta
                              }
                            </div>
                ...
                >
                  ...
                  >
                    <div className="dashboard-section-card__main">
                      ...
                      >
                        <div className="dashboard-section-card__title">
                          {
                            section.title
                          }
                        </div>

                        <div className="dashboard-section-card__description">
                          {
                            section.description
                          }
                        </div>
          ...
          >
            <div className="dashboard-menu-header">
              ...
              <div className="dashboard-menu-profile">
                <div className="dashboard-menu-avatar">
                  {
                    accountInitial
                  }
                </div>
                ...
                >
                  <div className="dashboard-menu-title">
                    <span className="dashboard-menu-title__mobile">
                      Menu
                    </span>

                    <span className="dashboard-menu-title__desktop">
                      Library
                    </span>
                  </div>
                  ...
                  0 ? (
                      ...
                      (
                        ...
                        >
                          <span className="dashboard-menu-favorite__text">
                            ...
                            <span className="dashboard-menu-favorite__title">
                              {
                                item.topic_name
                              }
                            </span>
                    ...
                    <div className="soft dashboard-menu-empty">
                      {q
                        ...
                        : "No favorites saved yet. Tap the star on content you want to revisit."}
                    </div>
                  )}
                </div>
              </section>
